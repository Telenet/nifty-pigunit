...
/**
 * This is a modified version of the original file {@link org.apache.hadoop.fs.FileUtil}. This file was modified to
 * circumvent a native access problem specifically for the Windows OS.
 *
 * The 'hack' disables some security checks which include checking if the current user has Read / Write / Execute rights
 * on the file that is being accessed.
 *
 * @author mlavaert
 */
